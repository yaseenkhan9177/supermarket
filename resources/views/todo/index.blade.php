        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="flex flex-col">
                ...
                <div id="todo" class="kanban-col space-y-4 min-h-[200px]" data-status="todo">
                    ...
                    <button class="w-full py-3 border-2 border-dashed border-gray-300 text-gray-400 rounded-xl hover:border-indigo-400 hover:text-indigo-500 transition text-sm font-medium">
                        + Add Card
                    </button>
                </div>
            </div>
