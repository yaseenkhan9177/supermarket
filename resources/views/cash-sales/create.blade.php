...
<div class="max-w-7xl mx-auto" x-data="cashSaleInvoice()">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mb-8">
        ...
        <div class="bg-slate-900 rounded-2xl shadow-xl border border-slate-800 p-6 relative overflow-hidden group">
            <div class="absolute -right-6 -top-6 w-32 h-32 bg-blue-500/10 group-hover:bg-blue-500/20 rounded-full blur-2xl transition duration-300"></div>
            <h3 class="text-white text-lg font-bold mb-5 flex items-center gap-3 relative z-10">
                <div class="w-8 h-8 rounded-lg bg-blue-500/20 text-blue-500 border border-blue-500/30 flex items-center justify-center shadow-sm">
        ...
        <div class="bg-slate-900 rounded-2xl shadow-xl border border-slate-800 p-6 relative overflow-hidden group">
            <div class="absolute -right-6 -top-6 w-32 h-32 bg-green-500/10 group-hover:bg-green-500/20 rounded-full blur-2xl transition duration-300"></div>
            <h3 class="text-white text-lg font-bold mb-5 flex items-center gap-3 relative z-10">
                <div class="w-8 h-8 rounded-lg bg-green-500/20 text-green-500 border border-green-500/30 flex items-center justify-center shadow-sm">
        ...
        <div class="bg-slate-900 rounded-2xl shadow-xl border border-slate-800 p-6 relative overflow-hidden group">
            ...
            <div class="absolute -right-6 -top-6 w-32 h-32 bg-yellow-500/10 group-hover:bg-yellow-500/20 rounded-full blur-2xl transition duration-300"></div>
            <h3 class="text-white text-lg font-bold mb-3 flex items-center gap-3 relative z-10">
                <div class="w-8 h-8 rounded-lg bg-yellow-500/20 text-yellow-500 border border-yellow-500/30 flex items-center justify-center shadow-sm">
            ...
            <div class="flex justify-between items-end mb-3 pt-2 border-t border-slate-800">
                ...
                <span class="text-3xl lg:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-300 tracking-tight" x-text="'Rs. ' + netTotal"></span>
            </div>
            <div class="flex gap-2 mb-2">
                <div class="relative flex-1">
                    <span class="absolute left-3 top-2.5 text-slate-500 font-bold">Rs.</span>
                    <input type="number" id="received-amount" x-model="received_amount" @keydown.enter.prevent="saveInvoice()" placeholder="0" class="w-full bg-slate-950 border border-slate-700 rounded-lg pl-10 pr-3 py-2 text-white font-bold focus:border-yellow-500 outline-none text-lg">
                </div>
    ...
    function cashSaleInvoice() {
        return {
            ...
            get netTotal() {
                ...
                return Math.max(0, sub + tax - ret).toFixed(2);
            },
            ...
            async performSearch() {
                ...
                try {
                    let response = await fetch(`/cash-sales/search?q=${encodeURIComponent(query)}`);
